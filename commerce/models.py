...
class Invoice(models.Model):
    ...
    payment_method = models.CharField(
        ...
        max_length=2,
        choices=InvoicePaymentMethod.choices,
        default=InvoicePaymentMethod.CASH,
    )
    issue_date = models.DateTimeField(
        verbose_name="Fecha Emision", default=timezone.now
    )
    ...
    payment = models.DecimalField(
        verbose_name="Pago", default=0, max_digits=16, decimal_places=2
    )
    change = models.DecimalField(
        verbose_name="Cambio", default=0, max_digits=16, decimal_places=2
    )
...
class InvoiceDetail(models.Model):
    invoice = models.ForeignKey(
        Invoice, on_delete=models.CASCADE, related_name="detail", verbose_name="Factura"
    )
    ...
    cost = models.DecimalField(
        default=0, max_digits=16, decimal_places=2, null=True, blank=True
    )
...
class PurchaseDetail(models.Model):
    ...
    subtotal = models.DecimalField(
        verbose_name="subtototal", default=0, max_digits=16, decimal_places=2
    )
    iva = models.DecimalField(
        verbose_name="Iva", default=0, max_digits=16, decimal_places=2
    )
