...
urlpatterns = [
    ...
    path(
        "brand_update/<int:pk>/", views.BrandUpdateView.as_view(), name="brand_update"
    ),
    path(
        "brand_delete/<int:pk>/", views.BrandDeleteView.as_view(), name="brand_delete"
    ),
    path(
        "search_customers/", views.CustomerSearchView.as_view(), name="customer_search"
    ),
]
