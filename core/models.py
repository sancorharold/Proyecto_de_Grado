...
class Customer(models.Model):
    dni = models.CharField(
        verbose_name="Dni", max_length=13, unique=True, blank=True, null=True
    )
    ...
    gender = models.CharField(
        verbose_name="Sexo",
        max_length=1,
        choices=CustomerGender,
        default=CustomerGender.MALE,
    )
    date_of_birth = models.DateField(
        verbose_name="Fecha Nacimiento", blank=True, null=True
    )
    phone = models.CharField(max_length=10, validators=[phone_validator])
    email = models.EmailField(
        verbose_name="Correo", max_length=100, blank=True, null=True
    )
...
class Product(models.Model):
    ...
    cost = models.DecimalField(
        "Costo Producto", max_digits=10, decimal_places=2, default=Decimal("0.0")
    )
    price = models.DecimalField(
        "Precio", max_digits=10, decimal_places=2, default=Decimal("0.0")
    )
    ...
    iva = models.IntegerField(
        verbose_name="IVA", choices=ProductIva.choices, default=ProductIva.FIFTEEN
    )
    ...
    def get_categories(self):
        return " - ".join(
            [c.description for c in self.categories.all().order_by("description")]
        )
